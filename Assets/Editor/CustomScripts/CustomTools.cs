...
public class _ads_maker : EditorWindow
{
    ...
    [MenuItem("Custom Tools/Delete All Player Preferences")]
    ...
    [MenuItem("Custom Tools/Detach All Childrens")]
    private static void DetachAllChildrens() {
    ...
    [MenuItem("Custom Tools/Anchors/Set Anchors to Corners for Selected GameObject #Z")]
    ...
    [MenuItem("Custom Tools/Anchors/Set Anchors to Corners for Selected GameObjects #X")]
    ...
    //		}
    [MenuItem("Custom Tools/Anchors/Set Anchors to Corners for Whole Canvas %&C")]
